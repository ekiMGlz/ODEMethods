...
aproximación del método en t=1.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{n}{f} \PY{o}{=} \PY{k}{lambda} \PY{n}{t}\PY{p}{,} \PY{n}{y} \PY{p}{:} \PY{n}{y}\PY{o}{+}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{t}\PY{p}{)}
        ...
        \PY{n}{Latex}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdl{}E\PYZus{}}\PY{l+s+si}{\PYZob{}Trapecio\PYZcb{}}\PY{l+s+s2}{(h\PYZus{}1)= }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}\PY{n+nb}{str}\PY{p}{(}\PY{n}{globalError}\PY{p}{)} \PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}}\PY{l+s+s1}{\PYZsq{}} \PY{p}{)}
\end{Verbatim}
...
\[E_{Trapecio}(h_2)=\left|w_{20}-y(1) \right|\]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n}{T}\PY{p}{,} \PY{n}{W} \PY{o}{=} \PY{n}{odesolver}\PY{o}{.}\PY{n}{solve}\PY{p}{(}\PY{n}{f}\PY{p}{,}\PY{n}{y0}\PY{p}{,}\PY{n}{I}\PY{p}{,}\PY{l+m+mi}{20}\PY{p}{,}\PY{n}{method}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Explicit Trapezoid}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        
        \PY{n}{globalError} \PY{o}{=} \PY{n+nb}{abs}\PY{p}{(}\PY{n}{W}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{20}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{y1}\PY{p}{)}
        
        \PY{n}{Latex}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdl{}E\PYZus{}}\PY{l+s+si}{\PYZob{}Trapecio\PYZcb{}}\PY{l+s+s2}{(h\PYZus{}2)= }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}\PY{n+nb}{str}\PY{p}{(}\PY{n}{globalError}\PY{p}{)} \PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
usando \(h_1=0.1\) : \[E_{RK4}(h_1)=\left|w_{10}-y(1) \right|\]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{T}\PY{p}{,} \PY{n}{W} \PY{o}{=} \PY{n}{odesolver}\PY{o}{.}\PY{n}{solve}\PY{p}{(}\PY{n}{f}\PY{p}{,}\PY{n}{y0}\PY{p}{,}\PY{n}{I}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{,}\PY{n}{method}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{RK4}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        
        \PY{n}{globalError} \PY{o}{=} \PY{n+nb}{abs}\PY{p}{(}\PY{n}{W}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{y1}\PY{p}{)}
        
        \PY{n}{Latex}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdl{}E\PYZus{}}\PY{l+s+si}{\PYZob{}RK4\PYZcb{}}\PY{l+s+s2}{(h\PYZus{}1)= }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}\PY{n+nb}{str}\PY{p}{(}\PY{n}{globalError}\PY{p}{)} \PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
