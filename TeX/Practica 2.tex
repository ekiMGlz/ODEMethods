...
A continuación los ejercicios de la práctica. Todos fueron realizados en Python 3.6 utilizando los paquetes \textit{numpy} y \textit{scipy.op}. También se incluye un cuaderno de IPython para cada ejercicio dentro de la carpeta Ejercicios, junto con los scripts \textit{.py} Para obtener los resultados. Cada uno de estos utiliza los siguientes imports:
